                                ...
                                <tbody>
                                    <tr className="cart-content">
                                        ...
                                        <td className="cart-price">
                                            <h5>{new Intl.NumberFormat().format(item.price)} đ</h5>
                                        </td>
                                        <td className="cart-qty">
                                            <a className="btn btn-success" onClick={() => handleDecrement(item,index)}>  - </a>
                                            <input className="inputt" type="text" name="quantity" value={item.qty}/>
                                            <a className="btn btn-success" onClick={() => handleIncrement(item,index)}>  + </a> 
                                        </td>
                                        <td className="cart-price">
                                            <h5>{new Intl.NumberFormat().format(item.price * item.qty)} đ</h5>
                                        </td>
                                        <td className="cart-remove">
                                            <i class="fa fa-trash" onClick={() => handleRemove(item,index)}></i>
                                        </td>
                                    </tr>
                                </tbody>
                            )
